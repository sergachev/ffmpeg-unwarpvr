...
../../ffmpeg -y -i lava_clip_short.mp4 -vf unwarpvr=1920:1080 -c:a copy -c:v libx264 -crf 14 output_cropped.mp4
../../ffmpeg -y -i lava_clip_short.mp4 -vf unwarpvr=2364:1461 -c:a copy -c:v libx264 -crf 14 output_full.mp4
